...
HTMLHelper::_('stylesheet', 'media/plg_system_fieldtypes/css/tags-checkboxes.min.css', array('version' => 'auto'));

?>
<div data-input-tags-checkboxes="<?php echo $id ?>" class="<?php echo $class; ?>">
	<div class="level-1">
		<?php foreach ($children[1] as $tag): ?>
			<div class="item">
				<div class="tag">
